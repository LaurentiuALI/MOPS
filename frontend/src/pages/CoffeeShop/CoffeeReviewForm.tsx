...
import { IReview } from "./CoffeeShop";
...
function CoffeeReviewForm({
  ...
  const handleFormSubmit = (e: FormEvent) => {
    e.preventDefault();
    axios
      .post(`${import.meta.env.VITE_URL}reviews/add`, {
  ...
  return (
    <>
      <h1 className="font-bold leading-[130%] text-[20px]">
        Leave us a review
      </h1>
      <form onSubmit={handleFormSubmit} className="flex flex-col  gap-[12px]">
        <div className="flex justify-between gap-[8px]">
          <select
            ...
            id="product"
            className="flex p-[12px] justify-between items-center rounded border-2 border-brand-borderDark w-full"
          >
          ...
          <select
            ...
            className="rounded border-2 border-brand-borderDark p-[12px]"
          >
